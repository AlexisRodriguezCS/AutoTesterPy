...
<p align="center">
  <img src="https://raw.githubusercontent.com/AlexisRodriguezCS/AutoTesterPy/main/images/selenium.png" alt="selenium" style="display:block;margin:auto;" height="500">
</p>
...
| File                                      | Description                                                                                                     |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| user_registration_test.py:                | Testing the registration process, from signing up to creating an account, logging in, and deleting the account. |
| login_user_correct_test.py                | Testing the login process with correct email and password.                                                      |
| login_user_incorrect_test.py              | Testing the login process with incorrect email and password.                                                    |
| logout_user_test.py                       | Testing the logout process.                                                                                     |
| register_user_existing_email.py           | Testing the registration process with an existing email.                                                        |
| contact_us_form_test.py                   | Testing the contact us form functionality.                                                                      |
| verify_test_cases_page.py                 | Testing the functionality to verify the test cases page.                                                        |
| verify_all_products_and_product_detail.py | Testing the functionality to verify all products and product detail pages.                                      |
| search_product_test.py                    | Testing the functionality to search for a product.                                                              |
| verify_subscription_home_page.py          | Testing the subscription functionality on the home page.                                                        |
| verify_subscription_cart_page.py          | Testing the subscription functionality on the cart page.                                                        |
| add_products_in_cart.py                   | Testing the functionality to add products to the cart.                                                          |
| verify_product_quantity_in_cart.py        | Testing the functionality to verify product quantity in the cart.                                               |
